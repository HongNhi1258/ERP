...
{
  public partial class viewFGH_04_003 : MainUserControl
  {
    #region Field
    ...
    private void LoadData()
    {
      ...
      if (this.inStorePid == long.MinValue)
      {
        ...
        commandText += "SELECT dbo.FWHFGetNewInStoreCodeAdjustment()";
      ...
      {
        string strCommandText = "SELECT InStoreCode, Note, Posting FROM TblWHFInStore WHERE PID = " + this.inStorePid;
        ...
        string commandText = "  SELECT		  ROW_NUMBER() OVER( ORDER BY BOX.SeriBoxNo ) AS [No] , ";
    ...
    private void btnSave_Click(object sender, EventArgs e)
    {
      ...
      if (this.inStorePid == long.MinValue)
      {
        ...
        DataBaseAccess.ExecuteStoreProcedure("spWHFInStoreAdjustment_Insert", arrInputParam, arrOutputParam);
      ...
      else
      {
        ...
        DataBaseAccess.ExecuteStoreProcedure("spWHFInStoreAdj_Update", arrInputParam);
    ...
    private void btnAddDetail_Click(object sender, EventArgs e)
    {
      ...
      WindowUtinity.ShowView(uc, "ADD DETAIL - ADJUSTMENT IN", false, ViewState.ModalWindow);
    ...
    private void btnAddDetailFromFile_Click(object sender, EventArgs e)
    {
      ...
      uc.receiptPid = this.inStorePid;
      uc.flagReturn = 0;
      WindowUtinity.ShowView(uc, "ADD DETAIL FROM FILE - ADJUSTMENT IN", false, ViewState.ModalWindow);
    ...
    private void btnPrint_Click(object sender, EventArgs e)
    {
      ...
      view.inStorePid = this.inStorePid;
      view.ncategory = 5;
