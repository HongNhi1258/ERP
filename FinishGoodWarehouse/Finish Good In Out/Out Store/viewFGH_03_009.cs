/*
  Author      : Duong Minh
  Date        : 14/05/2012
  Description : Issuing For Container - Special
*/
using System;
...
{
  public partial class viewFGH_03_009 : MainUserControl
  {
    #region Field
    ...
    private void LoadData()
    {
      ...
      if (this.outStorePid == long.MinValue)
      {
        ...
        commandText += "SELECT dbo.FWHFGetNewOutStoreCode('09SPI')";
    ...
    private void ultSummary_InitializeLayout(object sender, InitializeLayoutEventArgs e)
    {
      ...
      e.Layout.Bands[0].Columns["LoadingQty"].Header.Caption = "Loading Qty";
