/*
    - Võ Hoa Lư cập nhật vào ngày 05/11/2010.
      Nội dung cập nhật : khai báo biến toàn cục connectionString và xóa đi các biến cục bộ trong mỗi hàm.
 */
...
namespace DaiCo.Shared.DataBaseUtility
{
  ...
  /// </summary>
  public class BYSDataBaseAccess
  {
    private static string connectionString = DBConvert.DecodeConnectiontring(ConfigurationSettings.AppSettings["BYSConnectionString"]);
    ...
    public static DataSet SearchStoreProcedure(string storeProcedureName, params DBParameter[] inputParameters)
    {
      ...
      {
        foreach (DBParameter param in inputParameters)
        {
          if (param != null)
          {
            DataParameter.AddParameter(cmm, param.ParameterName, param.DbType, param.Value);
          }
        }
      }
    ...
    /// <param name="inputParameters">Condition search</param>
    /// <returns>Data set</returns>
    public static DataSet SearchStoreProcedure(string storeProcedureName, int commandTimeout, params DBParameter[] inputParameters)
    {
      SqlCommand cmm = new SqlCommand(storeProcedureName);
      cmm.Connection = new SqlConnection(connectionString);
      cmm.CommandType = CommandType.StoredProcedure;
    ...
    /// <returns>Data set</returns>
    public static DataSet SearchStoreProcedure(string storeProcedureName, DBParameter[] inputParameters, params DBParameter[] outputParameters)
    {
      SqlCommand cmm = new SqlCommand(storeProcedureName);
      cmm.Connection = new SqlConnection(connectionString);
      cmm.CommandType = CommandType.StoredProcedure;
      ...
      {
        foreach (DBParameter param in outputParameters)
        {
          if (param != null)
          {
            DataParameter.AddParameter(cmm, ParameterDirection.Output, param.ParameterName, param.DbType, param.Size, param.Value);
          }
        }
      }
      DataSet result = new DataSet();
      try
      {
        ...
        {
          foreach (DBParameter outParam in outputParameters)
          {
            IDbDataParameter param = (IDbDataParameter)cmm.Parameters[outParam.ParameterName];
    ...
    /// <param name="outputParameters">List output paramaters</param>
    /// <returns>Data set</returns>
    public static DataSet SearchStoreProcedure(string storeProcedureName, int commandTimeout, DBParameter[] inputParameters, params DBParameter[] outputParameters)
    {
      SqlCommand cmm = new SqlCommand(storeProcedureName);
      cmm.Connection = new SqlConnection(connectionString);
      cmm.CommandType = CommandType.StoredProcedure;
    ...
    public static DataTable SearchStoreProcedureDataTable(string storeProcedureName, params DBParameter[] inputParameters)
    {
    ...
    /// <param name="inputParameters">Condition search</param>
    /// <returns>Data table</returns>
    public static DataTable SearchStoreProcedureDataTable(string storeProcedureName, int commandTimeout, params DBParameter[] inputParameters)
    {
    ...
    /// <param name="outputParameters">List output paramaters</param>
    /// <returns>Data table</returns>
    public static DataTable SearchStoreProcedureDataTable(string storeProcedureName, DBParameter[] inputParameters, params DBParameter[] outputParameters)
    {
    ...
    /// <param name="outputParameters">List output paramaters</param>
    /// <returns>Data table</returns>
    public static DataTable SearchStoreProcedureDataTable(string storeProcedureName, int commandTimeout, DBParameter[] inputParameters, params DBParameter[] outputParameters)
    {
    ...
    /// <param name="inputParameters">Condition search</param>
    /// <returns>Data set</returns>
    public static DataSet SearchCommandText(string commandText, params DBParameter[] inputParameters)
    {
    ...
    /// <param name="inputParameters">Condition search</param>
    /// <returns>Data set</returns>
    public static DataSet SearchCommandText(string commandText, int commandTimeout, params DBParameter[] inputParameters)
    {
      SqlCommand cmm = new SqlCommand(commandText);
      cmm.Connection = new SqlConnection(connectionString);
      cmm.CommandType = CommandType.Text;
    ...
    /// <param name="inputParameters">Condition search</param>
    /// <returns>Data table</returns>
    public static DataTable SearchCommandTextDataTable(string commandText, params DBParameter[] inputParameters)
    {
    ...
    /// <param name="inputParameters">Condition search</param>
    /// <returns>Data table</returns>
    public static DataTable SearchCommandTextDataTable(string commandText, int commandTimeout, params DBParameter[] inputParameters)
    {
    ...
    public static List<T> SearchCommandObjects<T>(string commandText, params DBParameter[] inputParameters)
    {
    ...
    /// <param name="inputParameters">Condition search</param>
    /// <returns>List data with type is T</returns>
    public static List<T> SearchStoreProcedure<T>(string storeProcedureName, params DBParameter[] inputParameters)
    {
      List<T> result = new List<T>();
      Type myType = typeof(T);
      if (myType != null)
    ...
    public static void ExecuteStoreProcedure(string storeProcedureName, DBParameter[] inputParameters, params DBParameter[] outputParameters)
    {
      SqlCommand cmm = new SqlCommand(storeProcedureName);
      cmm.Connection = new SqlConnection(connectionString);
      cmm.CommandType = CommandType.StoredProcedure;
    ...
    /// <summary>
    /// Execute by store with timeOut, input and outupt params
    /// </summary>
    /// <param name="storeProcedureName">Store name</param>
    /// <param name="inputParameters">Input params</param>
    /// <param name="outputParameters">Output params</param>
    public static void ExecuteStoreProcedure(string storeProcedureName, int commandTimeOut, DBParameter[] inputParameters, params DBParameter[] outputParameters)
    {
      SqlCommand cmm = new SqlCommand(storeProcedureName);
      cmm.Connection = new SqlConnection(connectionString);
      cmm.CommandType = CommandType.StoredProcedure;
    ...
    public static object ExecuteScalarCommandText(string commantText, params DBParameter[] inputParameters)
    {
    ...
    public static bool ExecuteStoreProcedure(string storeProcedureName, params DBParameter[] inputParameters)
    {
      SqlCommand cmm = new SqlCommand(storeProcedureName);
      cmm.Connection = new SqlConnection(connectionString);
      cmm.CommandType = CommandType.StoredProcedure;
    ...
    /// <returns>True if success, False if error</returns>
    public static bool ExecuteCommandText(string commantText, params DBParameter[] inputParameters)
    {
      SqlCommand cmm = new SqlCommand(commantText);
      cmm.Connection = new SqlConnection(connectionString);
      cmm.CommandType = CommandType.Text;
    ...
    public static bool UpdateDataTable(DataTable dataSource, string commandText, params DBParameter[] parameters)
    {
      ...
      if (parameters != null && parameters.Length > 0)
      {
        foreach (DBParameter param in parameters)
        {
          if (param != null)
          {
            DataParameter.AddParameter(command, param.ParameterName, param.DbType, param.Value);
          }
        }
      }
    ...
    public static bool UpdateDataTable(DataRow[] rows, string commandText, params DBParameter[] parameters)
    {
      SqlCommand command = new SqlCommand();
      command.Connection = new SqlConnection(connectionString);
      command.CommandType = CommandType.Text;
