...
namespace DaiCo.General
{
  public partial class viewGNR_02_002 : MainUserControl
  {
    ...
    private void LoadItemCode()
    {
      ...
      if (ultcbWO.Value != null)
      {
        ...
        commandText = string.Format(@"SELECT ItemCode, Revision, ItemCode + ' - Revision : ' + CONVERT(varchar, Revision) Descption
                                           ...
                                           WHERE WorkOrderPid = {0} ORDER BY ItemCode DESC", wo); 
      }
      else
      {
        commandText = string.Format(@"SELECT ItemCode, Revision, ItemCode + ' - Revision : ' + CONVERT(varchar, Revision) Descption
      ...
      ultcbItem.DataSource = dtSource;
      ultcbItem.ValueMember = "ItemCode";
      ultcbItem.DisplayMember = "Descption";
      ultcbItem.DisplayLayout.Bands[0].Columns["Descption"].Width = 200;
      ultcbItem.DisplayLayout.Bands[0].Columns["ItemCode"].Hidden = true;
      ultcbItem.DisplayLayout.Bands[0].Columns["Revision"].Hidden = true;
      ultcbItem.DisplayLayout.Bands[0].ColHeadersVisible = false;
    }
    ...
    private void LoadMaterial()
    {
      ...
      {
        ultcbMaterialCode.DataSource = dtMaterial;
        ultcbMaterialCode.ValueMember = "MaterialCode";
        ultcbMaterialCode.DisplayMember = "Display";
        ultcbMaterialCode.DisplayLayout.Bands[0].Columns["Display"].Hidden = true;
    ...
    private void Search()
    {
      ...
      if (radProduction.Checked)
      {
        if (ultcbMaterialCode.Value != null || ultcbWO.Value != null || ultcbItem.Value != null || ultcbSupplement.Value != null || txtMaterialName.Text.Trim().Length > 0)
        {
          ...
          // Warehouse
          inputParam[7] = new DBParameter("@Warehouse", DbType.Int32, ConstantClass.MATERIALS_WAREHOUSE);
      ...
      else if(radOrderDepartment.Checked)
      {
        ...
        // Warehouse
        input[4] = new DBParameter("@Warehouse", DbType.Int32, ConstantClass.MATERIALS_WAREHOUSE);
    ...
    private void ultBefore_InitializeLayout(object sender, InitializeLayoutEventArgs e)
    {
      ...
      e.Layout.Bands[0].Columns["TotalRequired"].Header.Caption = "Total Required";
      e.Layout.Bands[0].Columns["Revision"].Header.Caption = "Rev.";
      e.Layout.Bands[0].Columns["MaterialName"].Header.Caption = "MaterialName(En)";
      e.Layout.Bands[0].Columns["MaterialNameVn"].Header.Caption = "MaterialName(Vn)";
      e.Layout.Bands[0].Columns["QtyBOM"].Header.Caption = "Unit BOM";
      ...
      e.Layout.Bands[0].Columns["MaterialName"].MaxWidth = 180;
      e.Layout.Bands[0].Columns["MaterialName"].MinWidth = 180;
