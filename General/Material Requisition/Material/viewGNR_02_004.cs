...
namespace DaiCo.General
{
  public partial class viewGNR_02_004 : MainUserControl
  {
    ...
    private void LoadLocation()
    {
      ...
      ControlUtility.LoadUltraCombo(ultLocation, dt, "Value", "Display", false, "Value");
    }
    ...
    private void Search()
    {
      ...
      if (ultcbMaterialCode.Value != null || ultLocation.Value != null || ultcbWO.Value != null || ultcbItem.Value != null || ultcbSupplement.Value != null || txtMaterialName.Text.Trim().Length > 0 || txtPartCode.Text.Trim().Length > 0)
      {
        ...
        dsBefore = DataBaseAccess.SearchStoreProcedure("spGNRGetRequiredMaterialsForRequestPart", 300, inputParam);
      }
      else
      {
    ...
    {
      ControlUtility.ExportToExcelWithDefaultPath(ultAfter, "Data");
    }
  }
}