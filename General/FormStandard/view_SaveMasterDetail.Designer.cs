namespace DaiCo.General
{
  partial class view_SaveMasterDetail
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.tableLayoutPanel1.Controls.Add(this.gpbMaster, 0, 0);
      this.tableLayoutPanel1.Controls.Add(this.gpbDetail, 0, 1);
      ...
      this.chkConfirm.Location = new System.Drawing.Point(524, 6);
      ...
      // ucbWo
      // 
      this.ucbWo.CharacterCasing = System.Windows.Forms.CharacterCasing.Normal;
      this.ucbWo.Cursor = System.Windows.Forms.Cursors.Default;
      this.ucbWo.DisplayLayout.AutoFitColumns = true;
      ...
      this.ugdData.DisplayLayout.AutoFitColumns = true;
