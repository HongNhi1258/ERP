...
{
  public partial class viewPLN_05_010 : MainUserControl
  {
    ...
    private void btnSearch_Click(object sender, EventArgs e)
    {
      ...
      DataTable dtSourceDB = Shared.DataBaseUtility.DataBaseAccess.SearchStoreProcedureDataTable("spPLNListItemOfSaleOrderCancel ", inputParam);
    ...
    {
      Shared.Utility.ControlUtility.SetPropertiesUltraGrid(ultraGridSaleOrderDetail);
