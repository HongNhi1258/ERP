...
namespace DaiCo.Planning
{
  public partial class viewPLN_02_002 : MainUserControl
  {
    ...
    private long SaveWorkOrder()
    {
      ...
      workOrder.Type = DBConvert.ParseInt(Shared.Utility.ControlUtility.GetSelectedValueCombobox(cmbType));
      workOrder.Status = 0;
    ...
    private void dgvData_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
    {
      ...
      Shared.Utility.ControlUtility.SetPropertiesUltraGrid(dgvData);
    ...
    private void btnPrint_Click(object sender, EventArgs e)
    {
      ...
      {
        //bool check = exportDataToExcel("Work Order Detail Information", dtDetail);
        //if (check == true)
        //{
        //  WindowUtinity.ShowMessageSuccess("MSG0044");
        //}
        {
          //bool check = exportDataToExcel("Sale Order Information", dtMain);
          //if (check == true)
          //{
          //  WindowUtinity.ShowMessageSuccess("MSG0044");
          //}
    ...
    private bool exportDataToExcel(string tieude, DataTable dt)
    {
      bool result = false;
      ...
      GoBack:
        ...
        try
        {
          xlBook.SaveAs(strName, Excel.XlFileFormat.xlWorkbookNormal, missValue, missValue, missValue, missValue, Excel.XlSaveAsAccessMode.xlNoChange, Excel.XlSaveConflictResolution.xlLocalSessionChanges, missValue, missValue, missValue, false);
        }
        catch
        {
          return false;
