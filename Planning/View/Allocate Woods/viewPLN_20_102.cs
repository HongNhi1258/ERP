...
{
  public partial class viewPLN_20_102 : DaiCo.Shared.MainUserControl
  {
    #region Init
    public viewPLN_20_102()
    {
      InitializeComponent();
    }
    ...
    private void btnSave_Click(object sender, EventArgs e)
    {
      ...
      inputParam[3] = new DBParameter("@Qty", DbType.Double, DBConvert.ParseDouble(this.txtQty.Text) * (-1));
    ...
    private void SelectIndexChange()
    {
      ...
      string commandText = "SELECT dbo.FPLNWoodsGetRemainQtyOfDeptAllocate(@Department, @Group, @Category)";
