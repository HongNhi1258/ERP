...
namespace DaiCo.Planning
{
  public partial class viewPLN_01_007 : MainUserControl
  {
    ...
    {
      Shared.Utility.ControlUtility.SetPropertiesUltraGrid(ultrCarcassStatus);
      e.Layout.AutoFitColumns = true;
      e.Layout.Override.AllowAddNew = Infragistics.Win.UltraWinGrid.AllowAddNew.No;
      e.Layout.Override.AllowDelete = Infragistics.Win.DefaultableBoolean.False;
      e.Layout.Override.AllowUpdate = Infragistics.Win.DefaultableBoolean.False;
    ...
    {
      string saleNo = Shared.Utility.ControlUtility.GetSelectedValueUltraCombobox(ultComboSaleNo);
      string itemCode = Shared.Utility.ControlUtility.GetSelectedValueUltraCombobox(ultComboItemCode);
      ...
      int revision = DBConvert.ParseInt(Shared.Utility.ControlUtility.GetSelectedValueUltraCombobox(ultComboRevision));
      string carcssCode = Shared.Utility.ControlUtility.GetSelectedValueUltraCombobox(ultComboCarcassCode);
    ...
    private void ultComboSaleNo_ValueChanged(object sender, EventArgs e)
    {
      ...
      {
        string saleNo = ControlUtility.GetSelectedValueUltraCombobox(ultComboSaleNo);
        string itemCode = ControlUtility.GetSelectedValueUltraCombobox(ultComboItemCode);
        int revision = DBConvert.ParseInt(ControlUtility.GetSelectedValueUltraCombobox(ultComboRevision));
        string carcassCode = ControlUtility.GetSelectedValueUltraCombobox(ultComboCarcassCode);
