...
namespace DaiCo.Planning
{
  public partial class viewPLN_29_001 : MainUserControl
  {
    ...
    private void ExportExcel()
    {
      ...
      {
        ControlUtility.ExportToExcelWithDefaultPath(ultData, "Deadline Information");

        //Excel.Workbook xlBook;

        //ControlUtility.ExportToExcelWithDefaultPath(ultData, out xlBook, "Deadline Information", 6);
    ...
    {
      Shared.Utility.ControlUtility.BOMShowItemImage(ultData, grpItemPicture, picItem, chkShowItem.Checked);
    }
