/*
  Author      : 
  Date        : 21/05/2013
  Description : List Supplement For Veneer
*/
...
{
  public partial class viewPLN_21_098 : MainUserControl
  {
    #region Init Form
    ...
    private void Search()
    {
      ...
      if (text.Length > 0)
      {
        inputParam[3] = new DBParameter("@MaterialCode", DbType.String, 1024, text);
      }
      ...
      DataSet ds = DataBaseAccess.SearchStoreProcedure("spPLNVeneerListSupplement", inputParam);
    ...
    {
      viewPLN_21_099 view = new viewPLN_21_099();
