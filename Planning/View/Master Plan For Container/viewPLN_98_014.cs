  ...
  public partial class viewPLN_98_014 : MainUserControl
  {
    ...
    private void LoadingList()
    {
      ...
      if (dsMain != null)
      {
        ...
        {
          ControlUtility.ExportToExcelWithDefaultPath(ultData, "LOADING LIST REPORT");
    ...
    private void ContainerLoadingPlan()
    {
      ...
      if (dsMain != null)
      {
        ...
        if (ultData.Rows.Count > 0)
        {
          ...
          ControlUtility.ExportToExcelWithDefaultPath(ultData, out xlBook, "CONTAINER LOADING PLAN REPORT", 6);
          ...
          xlSheet.Cells[3, 1] = "CONTAINER LOADING PLAN REPORT";
          r = xlSheet.get_Range("A3", "A3");
          r.Font.Bold = true;
          r.Font.Size = 14;
          r.EntireRow.RowHeight = 20;
