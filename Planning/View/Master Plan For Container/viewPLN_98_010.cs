...
namespace DaiCo.Planning
{
  public partial class viewPLN_98_010 : MainUserControl
  {
    ...
    private void LoadDistributor()
    {
      ...
      ultDistributor.DataSource = dt;
      ultDistributor.DisplayMember = "Value";
      ultDistributor.ValueMember = "Code";
      ultDistributor.DisplayLayout.Bands[0].Columns["Code"].Hidden = true;
      ultDistributor.DisplayLayout.Bands[0].Columns["Value"].Width = 300;
      ultDistributor.DisplayLayout.Bands[0].ColHeadersVisible = false;
    }
    ...
    private void LoadCustomer()
    {
      ...
      ultCustomer.ValueMember = "CustomerPid";
      ultCustomer.DisplayMember = "Name";
      ultCustomer.DisplayLayout.Bands[0].ColHeadersVisible = false;
      ultCustomer.DisplayLayout.Bands[0].Columns["CustomerPid"].Hidden = true;
      ultCustomer.DisplayLayout.Bands[0].Columns["CustomerCode"].Hidden = true;
