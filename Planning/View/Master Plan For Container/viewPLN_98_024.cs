  ...
  public partial class viewPLN_98_024 : MainUserControl
  {
    ...
    private void btnPrint_Click(object sender, EventArgs e)
    {
      if (ultraGridInformation.Rows.Count > 0)
      {
        ...
        AA.Rows.Band.Columns["PONo"].Header.Caption = "Sale No";
        AA.Rows.Band.Columns["LoadingListFrom"].Header.Caption = "Loading List From";
        AA.Rows.Band.Columns["MoveToLoadingList"].Header.Caption = "Move To Loading List";
        AA.Rows.Band.Columns["TextRevision"].Header.Caption = "Revision";
        AA.Rows.Band.Columns["TextOldShipDate"].Header.Caption = "Old ShipDate";
        AA.Rows.Band.Columns["TextNewShipDate"].Header.Caption = "New ShipDate";
        AA.Rows.Band.Columns["TextReasonMove"].Header.Caption = "ReasonMove";
        AA.Rows.Band.Columns["TextReasonChangeShipdate"].Header.Caption = "Reason Change Shipdate";




        AA.Rows.Band.Columns["ContainerPid"].Hidden = true;
        AA.Rows.Band.Columns["MoveContainerPid"].Hidden = true;
        AA.Rows.Band.Columns["Revision"].Hidden = true;
        AA.Rows.Band.Columns["OldShipDate"].Hidden = true;
        AA.Rows.Band.Columns["NewShipDate"].Hidden = true;
        AA.Rows.Band.Columns["ReasonMoveContainer"].Hidden = true;
        AA.Rows.Band.Columns["ReasonChangeShipDate"].Hidden = true;

        AA.Rows.Band.Columns["SOPid"].Hidden = true;
        AA.Rows.Band.Columns["Error"].Hidden = true;

        ControlUtility.ExportToExcelWithDefaultPath(AA, out xlBook, "Master Plan For Container", 7);
