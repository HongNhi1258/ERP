...
{
  public partial class viewPLN_10_021 : MainUserControl
  {
    #region field
    #endregion field
    ...
    /// <param name="e"></param>
    private void viewPLN_10_021_Load(object sender, EventArgs e)
    {
      txtHoldNo.Focus();
      ultDateFrom.Value = DBNull.Value;
      ultDateTo.Value = DBNull.Value;
    ...
    private void ultraGridInformation_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
    {
      ...
      e.Layout.Bands[0].Columns["Tab1"].Header.Caption = "Hold";
      e.Layout.Bands[0].Columns["Tab2"].Header.Caption = "Swap WOSO";
    ...
    private void ultraGridInformation_DoubleClick(object sender, EventArgs e)
    {
      ...
      {
        status = row.ParentRow.Cells["Status"].Value.ToString();
      }
      if (status != "New")
      {
        viewPLN_10_020 uc = new viewPLN_10_020();
        uc.holdPid = pid;
