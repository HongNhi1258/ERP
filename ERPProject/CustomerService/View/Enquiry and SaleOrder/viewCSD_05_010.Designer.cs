namespace DaiCo.ERPProject
{
  partial class viewCSD_05_010
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.ultraGridSaleOrderDetail.DisplayLayout.AutoFitStyle = Infragistics.Win.UltraWinGrid.AutoFitStyle.ResizeAllColumns;
