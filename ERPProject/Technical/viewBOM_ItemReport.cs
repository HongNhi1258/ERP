...
{
  public partial class viewBOM_ItemReport : MainUserControl
  {
    #region Field
    ...
    public viewBOM_ItemReport()
    {
      InitializeComponent();
    }

    private void viewBOM_ItemReport_Load(object sender, EventArgs e)
    {
      switch (ncategory)
      {
        case 0:
    ...
    {
      dsBOMGlassMasterList dsGlassMasterList = new dsBOMGlassMasterList();
      int no = 1;
    ...
    private void ReportItemCompHardware()
    {
      ...
      dsSource.Tables[0].Columns.Add("Image", typeof(System.Byte[]));
      dsSource.Tables[0].Columns.Add("Logo", typeof(System.Byte[]));
      dsSource.Tables[0].Columns.Add("Title", typeof(string));
      dsSource.Tables[0].Rows[0]["Title"] = "Hardware Master List 2nd Level";
      dsSource.Tables[0].Rows[0]["Image"] = FunctionUtility.ImagePathToByteArray(FunctionUtility.BOMGetItemImage(this.itemCode, this.revision));
      dsSource.Tables[0].Rows[0]["Logo"] = FunctionUtility.ImagePathToByteArray(string.Format("{0}{1}", System.Windows.Forms.Application.StartupPath, ConstantClass.PATH_LOGO));
      dsSource.Tables[1].Columns.Add("Image", typeof(System.Byte[]));
      ...
      DataSet dsHardware = CreateDataSet.ItemComPonentHadware();
      DataRow rowMaster = dsHardware.Tables["TblMasterInfo"].NewRow();
      rowMaster["UserName"] = Shared.Utility.SharedObject.UserInfo.EmpName;
      dsHardware.Tables["TblMasterInfo"].Rows.Add(rowMaster);
      foreach (DataRow row in dsSource.Tables[1].Rows)
      {
        row["Image"] = FunctionUtility.ImagePathToByteArray(FunctionUtility.BOMGetItemComponentImage(row["ComponentCode"].ToString()));
      }
      dsHardware.Tables["TblHardwareList"].Merge(dsSource.Tables[1]);

      DaiCo.ERPProject.Share.ReportTemplate.cptBOMItemComponentHardware cpt = new DaiCo.ERPProject.Share.ReportTemplate.cptBOMItemComponentHardware();
      string filePath = System.Windows.Forms.Application.StartupPath + @"\Share\ReportTemplate\cptBOMItemComponentHardware.rpt";
      cpt.FileName = filePath;
      cpt.Load();
      cpt.Subreports[0].SetDataSource(dsItemMaster);
      cpt.SetDataSource(dsHardware);
    ...
    private void ReportItemCompUpholstery()
    {
      ...
      DaiCo.ERPProject.Share.ReportTemplate.cptBOMItemComponentUpholstery cpt = new DaiCo.ERPProject.Share.ReportTemplate.cptBOMItemComponentUpholstery();
      string filePath = System.Windows.Forms.Application.StartupPath + @"\Share\ReportTemplate\cptBOMItemComponentUpholstery.rpt";
      cpt.FileName = filePath;
      cpt.Load();
      cpt.Subreports[0].SetDataSource(dsItemMaster);
    ...
    private void LoadDataSupportInfo()
    {
      ...
      DaiCo.ERPProject.Share.ReportTemplate.cptSupportInfoReport cpt = new DaiCo.ERPProject.Share.ReportTemplate.cptSupportInfoReport();
      string filePath = System.Windows.Forms.Application.StartupPath + @"\Share\ReportTemplate\cptSupportInfoReport.rpt";
      cpt.FileName = filePath;
      cpt.Load();
      cpt.SetDataSource(dsSource);
      cptItemMaterialViewer.ReportSource = cpt;
    ...
    private void ReportSupportMaterialInfo()
    {
      ...
      DaiCo.ERPProject.Share.ReportTemplate.cptBOMSupportMaterialInfo cpt = new DaiCo.ERPProject.Share.ReportTemplate.cptBOMSupportMaterialInfo();
      string filePath = System.Windows.Forms.Application.StartupPath + @"\Share\ReportTemplate\cptBOMSupportMaterialInfo.rpt";
      cpt.FileName = filePath;
      cpt.Load();
    ...
    private void ReportLabourInfo()
    {
      ...
      string commandTextItemInfo = string.Format(@" SELECT BS.SaleCode, BS.ItemCode, INFO.Revision, BS.Name [ItemName], BS.[Description], CM1.Category, 
      ...
      dtItemInfo.Columns.Add("Logo", typeof(System.Byte[]));
      dtItemInfo.Rows[0]["Logo"] = FunctionUtility.ImagePathToByteArray(string.Format("{0}{1}", System.Windows.Forms.Application.StartupPath, ConstantClass.PATH_LOGO));
      DataSet dsItemMaster = CreateDataSet.ItemMasterInfo();
      ...
      DaiCo.ERPProject.Share.ReportTemplate.cptBOMDirectLaborInfo cpt = new DaiCo.ERPProject.Share.ReportTemplate.cptBOMDirectLaborInfo();
      string filePath = System.Windows.Forms.Application.StartupPath + @"\Share\ReportTemplate\cptBOMDirectLaborInfo.rpt";
      cpt.FileName = filePath;
      cpt.Load();
      cpt.Subreports[0].SetDataSource(dsItemMaster);
    ...
    private void ReportItemComponentAccessory()
    {
      ...
      DaiCo.ERPProject.Share.ReportTemplate.cptBOMItemComponentAccessory cpt = new DaiCo.ERPProject.Share.ReportTemplate.cptBOMItemComponentAccessory();
      string filePath = System.Windows.Forms.Application.StartupPath + @"\Share\ReportTemplate\cptBOMItemComponentAccessory.rpt";
      cpt.FileName = filePath;
      cpt.Load();
    ...
    private void ReportComponentFinishing()
    {
      ...
      DaiCo.ERPProject.Share.ReportTemplate.cptBOMItemComponentFinishing cpt = new DaiCo.ERPProject.Share.ReportTemplate.cptBOMItemComponentFinishing();
      string filePath = System.Windows.Forms.Application.StartupPath + @"\Share\ReportTemplate\cptBOMItemComponentFinishing.rpt";
      cpt.FileName = filePath;
      cpt.Load();
      cpt.Subreports[0].SetDataSource(dsMasterInfo);
    ...
    private void ReportItemComponentGlass()
    {
      ...
      DaiCo.ERPProject.Share.ReportTemplate.cptBOMItemComponentGlass cpt = new DaiCo.ERPProject.Share.ReportTemplate.cptBOMItemComponentGlass();
      string filePath = System.Windows.Forms.Application.StartupPath + @"\Share\ReportTemplate\cptBOMItemComponentGlass.rpt";
      cpt.FileName = filePath;
      cpt.Load();
      cpt.Subreports[0].SetDataSource(dsMasterInfo);
    ...
    private void ReportItemMaster()
    {
      ...
      dsItemMaster.Tables["DataTable1"].Rows[0]["Logo"] = FunctionUtility.ImagePathToByteArray(string.Format("{0}{1}", System.Windows.Forms.Application.StartupPath, ConstantClass.PATH_LOGO));
      ...
      DaiCo.ERPProject.Share.ReportTemplate.cptBOMItemInfo cpt = new DaiCo.ERPProject.Share.ReportTemplate.cptBOMItemInfo();
      string filePath = System.Windows.Forms.Application.StartupPath + @"\Share\ReportTemplate\cptBOMItemInfo.rpt";
      cpt.FileName = filePath;
      cpt.Load();
      ...
      cpt.SetParameterValue("User", Shared.Utility.SharedObject.UserInfo.EmpName);
      cptItemMaterialViewer.ReportSource = cpt;
    }
