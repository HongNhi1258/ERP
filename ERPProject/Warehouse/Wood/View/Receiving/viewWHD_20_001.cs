/*
  Author      : Duong Minh
  Date        : 14/06/2012
  Description : Insert/Update Receiving From Production
*/
...
{
  public partial class viewWHD_20_001 : MainUserControl
  {
    #region Field
    // Pid Receiving
    ...
    /// <param name="e"></param>
    private void viewWHD_20_001_Load(object sender, EventArgs e)
    {      
    ...
    private void LoadData()
    {
      ...
      if (dtReceivingInfo.Rows.Count > 0)
      {
        ...
        this.ultDepartment.Value = row["ImportSource"].ToString();
      ...
      {
        DataTable dtReceiving = DataBaseAccess.SearchCommandTextDataTable("SELECT dbo.FWHDGetNewReceivingNoWoods('05RTW') NewReceivingNo");
    ...
    private bool SaveReceivingWoods()
    {
      ...
      if (this.receivingPid != long.MinValue)
      {
        ...
        // Import Source
        inputParamUpdate[3] = new DBParameter("@ImportSource", DbType.String, this.ultDepartment.Value.ToString());

        // Type
        inputParamUpdate[4] = new DBParameter("@Type", DbType.Int32, 2);
      ...
      else
      {
        ...
        // Import Source
        inputParamInsert[2] = new DBParameter("@ImportSource", DbType.String, this.ultDepartment.Value.ToString());

        // Type
        inputParamInsert[3] = new DBParameter("@Type", DbType.Int32, 2);
        ...
        // ReceivingNo
        inputParamInsert[6] = new DBParameter("@ReceivingNo", DbType.String, "05RTW");
