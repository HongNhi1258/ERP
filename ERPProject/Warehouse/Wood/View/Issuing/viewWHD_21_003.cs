/*
  Author      : Duong Minh
  Date        : 14/06/2012
  Description : Insert/Update Return To Supplier For Woods Warehouse
*/
...
{
  public partial class viewWHD_21_003 : MainUserControl
  {
    #region Field
    // Pid Issuing
    ...
    private void LoadData()
    {
      ...
      {
        DataTable dtReceiving = DataBaseAccess.SearchCommandTextDataTable("SELECT dbo.FWHDGetNewIssuingNoWoods('05RTS') NewIssuingNo");
    ...
    private bool SaveIssuingVeneer()
    {
      ...
      else
      {
        ...
        // ReceivingNo
        inputParamInsert[6] = new DBParameter("@IssuingNo", DbType.String, "05RTS");
