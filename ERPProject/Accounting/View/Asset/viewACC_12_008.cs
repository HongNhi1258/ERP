/*
  ...
  Date        : 16/04/2021
  Description : Asset transfer list
...
{
  public partial class viewACC_12_008 : MainUserControl
  {
    #region field
    ...
    {
      DataSet dsInit = SqlDataBaseAccess.SearchStoreProcedure("spACCAssetTransferList_Init");
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 6;
      string storeName = "spACCAssetTransfer_List";

      DBParameter[] inputParam = new DBParameter[paramNumber];
      if (txtAssetTransferCode.Text.ToString().Trim().Length > 0)
      {
        inputParam[0] = new DBParameter("@TransferCode", DbType.String, txtAssetTransferCode.Text.ToString());
      }
    ...
    /// <param name="e"></param>
    private void viewACC_12_008_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
    ...
    private void ugdInformation_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
    {
      ...
      e.Layout.Bands[0].Columns["TransferCode"].Header.Caption = "Mã chứng từ";
      e.Layout.Bands[0].Columns["TransferDesc"].Header.Caption = "Diễn giải";
      e.Layout.Bands[0].Columns["TransferDate"].Header.Caption = "Ngày chứng từ";
    ...
    {
      Utility.ExportToExcelWithDefaultPath(ugdInformation, "Danh sách phiếu điều chuyển tài sản");
    }
    ...
    {
      viewACC_12_007 view = new viewACC_12_007();
      Shared.Utility.WindowUtinity.ShowView(view, "Tạo mới phiếu điều chuyển tài sản", false, ViewState.MainWindow);
    }
    ...
    private void ugdInformation_MouseDoubleClick(object sender, MouseEventArgs e)
    {
      ...
      Shared.Utility.WindowUtinity.ShowView(view, "Chi tiết phiếu điều chuyển tài sản", false, ViewState.MainWindow);
    }
    #endregion event
  }
}
