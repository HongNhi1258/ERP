/*
  ...
  Date        : 16/04/2021
  Description : Asset stop depreciation list
...
{
  public partial class viewACC_12_010 : MainUserControl
  {
    #region field
    ...
    {
      DataSet dsInit = SqlDataBaseAccess.SearchStoreProcedure("spACCAssetStopDepreciationList_Init");
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 6;
      string storeName = "spACCAssetStopDepreciation_List";

      DBParameter[] inputParam = new DBParameter[paramNumber];
      if (txtAssetTransferCode.Text.ToString().Trim().Length > 0)
      {
        inputParam[0] = new DBParameter("@StopCode", DbType.String, txtAssetTransferCode.Text.ToString());
      }
    ...
    {
      txtAssetTransferCode.Text = string.Empty;
    ...
    /// <param name="e"></param>
    private void viewACC_12_010_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
    ...
    private void ugdInformation_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
    {
      ...
      e.Layout.Bands[0].Columns["StopCode"].Header.Caption = "Mã chứng từ";
      e.Layout.Bands[0].Columns["StopDesc"].Header.Caption = "Diễn giải";
      e.Layout.Bands[0].Columns["StopDate"].Header.Caption = "Ngày chứng từ";
    ...
    {
      Utility.ExportToExcelWithDefaultPath(ugdInformation, "Danh sách phiếu ngưng khấu hao tài sản");
    }
    ...
    {
      viewACC_12_009 view = new viewACC_12_009();
      Shared.Utility.WindowUtinity.ShowView(view, "Tạo mới phiếu ngưng khấu hao tài sản", false, ViewState.MainWindow);
    }
    ...
    private void ugdInformation_MouseDoubleClick(object sender, MouseEventArgs e)
    {
      ...
      Shared.Utility.WindowUtinity.ShowView(view, "Chi tiết phiếu ngưng khấu hao tài sản", false, ViewState.MainWindow);
    }
    #endregion event
  }
}
