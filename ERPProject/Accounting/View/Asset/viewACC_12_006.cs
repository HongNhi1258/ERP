/*
  ...
  Date        : 16/04/2021
  Description : Asset shipment list
...
{
  public partial class viewACC_12_006 : MainUserControl
  {
    #region field
    ...
    {
      DataSet dsInit = SqlDataBaseAccess.SearchStoreProcedure("spACCAssetShipmentList_Init");
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 6;
      string storeName = "spACCAssetShipment_List";

      DBParameter[] inputParam = new DBParameter[paramNumber];
      if (txtAssetShipmentCode.Text.ToString().Trim().Length > 0)
      {
        inputParam[0] = new DBParameter("@ShipmentCode", DbType.String, txtAssetShipmentCode.Text.ToString());
      }
    ...
    {
      txtAssetShipmentCode.Text = string.Empty;
    ...
    /// <param name="e"></param>
    private void viewACC_12_006_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
    ...
    private void ugdInformation_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
    {
      ...
      e.Layout.Bands[0].Columns["ShipmentCode"].Header.Caption = "Mã chứng từ";
      e.Layout.Bands[0].Columns["ShipmentDesc"].Header.Caption = "Diễn giải";
    ...
    {
      Utility.ExportToExcelWithDefaultPath(ugdInformation, "Danh sách phiếu giảm tài sản");
    }
    ...
    {
      viewACC_12_005 view = new viewACC_12_005();
      Shared.Utility.WindowUtinity.ShowView(view, "Tạo mới phiếu giảm tài sản", false, ViewState.MainWindow);
    }
    ...
    private void ugdInformation_MouseDoubleClick(object sender, MouseEventArgs e)
    {
      ...
      Shared.Utility.WindowUtinity.ShowView(view, "Chi tiết phiếu giảm tài sản", false, ViewState.MainWindow);
    }
    #endregion event
  }
}
