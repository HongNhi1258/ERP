/*
  ...
  Date        : 9/04/2022
  Description : Account Document list
...
{
  public partial class viewACC_15_001 : MainUserControl
  {
    #region field
    ...
    private void InitData()
    {
      ...
      DataSet dsInit = SqlDataBaseAccess.SearchStoreProcedure("spACCPaymentRefundList_Init", inputParam);
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 6;
      string storeName = "spACCAccountDocument_Search";

      DBParameter[] inputParam = new DBParameter[paramNumber];
      if (txDocCode.Text.ToString().Trim().Length > 0)
      {
        inputParam[0] = new DBParameter("@DocCode", DbType.String, txDocCode.Text.ToString());
      }
      ...
      {
        inputParam[5] = new DBParameter("@Status", DbType.Int32, DBConvert.ParseInt(ucbStatus.Value));
      }
    ...
    /// <param name="e"></param>
    private void viewACC_15_001_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
    ...
    private void ugdInformation_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
    {
      ...
      e.Layout.Bands[0].Columns["DocDate"].Header.Caption = "Ngày chứng từ";
      e.Layout.Bands[0].Columns["Currency"].Header.Caption = "Tiền tệ";
      e.Layout.Bands[0].Columns["ExchangeRate"].Header.Caption = "Tỉ giá";
      e.Layout.Bands[0].Columns["DocDesc"].Header.Caption = "Diễn giải";
    ...
    {
      viewACC_15_002 view = new viewACC_15_002();
      Shared.Utility.WindowUtinity.ShowView(view, "Tạo mới phiếu kế toán", false, ViewState.MainWindow);
    }
    ...
    private void ugdInformation_MouseDoubleClick(object sender, MouseEventArgs e)
    {
      ...
      Shared.Utility.WindowUtinity.ShowView(view, "Chi tiết phiếu kế toán", false, ViewState.MainWindow);
    }
    #endregion event
  }
}
