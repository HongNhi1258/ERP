...
{
  public partial class viewACC_10_007 : MainUserControl
  {
    #region field
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 8;
      string storeName = "spACCPaymentVoucherForAdvance_Search";
    ...
    /// <param name="e"></param>
    private void viewACC_10_007_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
    ...
    private void ugdInformation_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
    {
      ...
      e.Layout.Bands[0].Columns["AdvanceCode"].Header.Caption = "Mã chứng từ";
      ...
      e.Layout.Bands[0].Columns["Paid"].Header.Caption = "Tiền đã ứng";
