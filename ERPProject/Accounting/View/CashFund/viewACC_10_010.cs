...
{
  public partial class viewACC_10_010 : MainUserControl
  {
    #region field
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 7;
      string storeName = "spACCPaymentRefund_Search";
    ...
    /// <param name="e"></param>
    private void viewACC_10_010_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
    ...
    private void btnNew_Click(object sender, EventArgs e)
    {
      ...
      Shared.Utility.WindowUtinity.ShowView(view, "Tạo mới phiếu hoàn ứng", false, ViewState.MainWindow);
    }
    ...
    private void ugdInformation_MouseDoubleClick(object sender, MouseEventArgs e)
    {
      ...
      Shared.Utility.WindowUtinity.ShowView(view, "Chi tiết phiếu hoàn ứng", false, ViewState.MainWindow);
    }
    #endregion event
  }
}
