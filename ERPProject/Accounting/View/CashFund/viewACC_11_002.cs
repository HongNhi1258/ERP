/*
  ...
  Date        : 16/04/2021
  Description : receipt voucher list
...
{
  public partial class viewACC_11_002 : MainUserControl
  {
    #region field
    ...
    private void InitData()
    {
      ...
      inputParam[0] = new SqlDBParameter("@DocTypePid", SqlDbType.Int, ConstantClass.Receipt_Voucher);
      DataSet dsInit = SqlDataBaseAccess.SearchStoreProcedure("spACCReceiptVoucherList_Init", inputParam);
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 5;
      string storeName = "spACCReceiptVoucher_List";

      DBParameter[] inputParam = new DBParameter[paramNumber];
      if (txtBankCreditCode.Text.ToString().Trim().Length > 0)
      {
        inputParam[0] = new DBParameter("@ReceiptCode", DbType.String, txtBankCreditCode.Text.ToString());
      }
    ...
    /// <param name="e"></param>
    private void viewACC_11_002_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
    ...
    private void ugdInformation_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
    {
      ...
      e.Layout.Bands[0].Columns["ReceiptDate"].Header.Caption = "Diễn giải";
      e.Layout.Bands[0].Columns["ReceiptDesc"].Header.Caption = "Mô tả";
    ...
    private void btnNew_Click(object sender, EventArgs e)
    {
      ...
      {
        viewACC_11_001 view = new viewACC_11_001();
        view.actionCode = DBConvert.ParseInt(ucbActionCode.Value);
        Shared.Utility.WindowUtinity.ShowView(view, "Tạo mới phiếu thu", false, ViewState.MainWindow);
      }
      else
      {
        WindowUtinity.ShowMessageErrorFromText("Vui lòng chọn loại phiếu thu.");
      }
    }
    ...
    private void ugdInformation_MouseDoubleClick(object sender, MouseEventArgs e)
    {
      ...
      Shared.Utility.WindowUtinity.ShowView(view, "Chi tiết phiếu thu", false, ViewState.MainWindow);
    }
    #endregion event
  }
}
