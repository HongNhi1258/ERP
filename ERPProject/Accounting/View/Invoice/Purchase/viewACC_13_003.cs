/*
  ...
  Date        : 16/04/2021
  Description : choose PO to make invoice in
...
{
  public partial class viewACC_13_003 : MainUserControl
  {
    #region field
    ...
    private void InitData()
    {
      ...
      DataSet dsInit = SqlDataBaseAccess.SearchStoreProcedure("spACCInvoiceChoosePO_Init", inputParam);
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 5;
      string storeName = "spACCInvoiceChoosePO_List";
    ...
    /// <param name="e"></param>
    private void viewACC_13_003_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
    ...
    private void ugdInformation_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
    {
      ...
      //Caption
      e.Layout.Bands[0].Columns["PONo"].Header.Caption = "Mã đơn hàng";
    ...
    private void btnSelect_Click(object sender, EventArgs e)
    {
      ...
      if (invalid)
      {
        for (int i = 0; i < ugdInformation.Rows.Count; i++)
        {
          ...
          {
            if (this.listPO != string.Empty)
            {
              this.listPO += ",";
            }
            this.listPO += row.Cells["PONo"].Value.ToString();
          }
        }
        this.CloseTab();
      }      
