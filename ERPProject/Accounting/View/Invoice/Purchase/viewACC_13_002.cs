...
{
  public partial class viewACC_13_002 : MainUserControl
  {
    #region field
    ...
    private void InitData()
    {
      ...
      inputParam[0] = new SqlDBParameter("@DocTypePid", SqlDbType.Int, ConstantClass.Invoice_Purchaser);
      DataSet dsInit = SqlDataBaseAccess.SearchStoreProcedure("spACCInvoiceList_Init", inputParam);
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 5;
      string storeName = "spACCInvoice_List";

      DBParameter[] inputParam = new DBParameter[paramNumber];
      if (txtBankCreditCode.Text.ToString().Trim().Length > 0)
      {
        inputParam[0] = new DBParameter("@InvoiceCode", DbType.String, txtBankCreditCode.Text.ToString());
      }
    ...
    /// <param name="e"></param>
    private void viewACC_13_002_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
    ...
    private void btnNew_Click(object sender, EventArgs e)
    {
      ...
      {
        viewACC_13_001 view = new viewACC_13_001();
        view.actionCode = DBConvert.ParseInt(ucbActionCode.Value);
        Shared.Utility.WindowUtinity.ShowView(view, "Tạo mới HĐ MH", false, ViewState.MainWindow);
      }
      else
      {
        WindowUtinity.ShowMessageErrorFromText("Vui lòng chọn loại hóa đơn mua hàng.");
      }
    }
    ...
    private void ugdInformation_MouseDoubleClick(object sender, MouseEventArgs e)
    {
      ...
      Shared.Utility.WindowUtinity.ShowView(view, "Chi tiết HĐ MH", false, ViewState.MainWindow);
    }
    #endregion event
  }
}
