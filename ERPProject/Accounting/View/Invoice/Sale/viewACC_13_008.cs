...
{
  public partial class viewACC_13_008 : MainUserControl
  {
    #region field
    ...
    {
      DataSet dsInit = SqlDataBaseAccess.SearchStoreProcedure("spACCARInvoiceOutDetailSOList_InitDoc");
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 8;
      string storeName = "spACCARInvoiceOutDetailSOList_SearchDoc";
    ...
    /// <param name="e"></param>
    private void viewACC_13_008_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
