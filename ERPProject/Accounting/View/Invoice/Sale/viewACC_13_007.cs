/*
  ...
  Date        : 24/05/2022
  Description : AR invoice out list
...
{
  public partial class viewACC_13_007 : MainUserControl
  {
    #region field
    ...
    private void InitData()
    {
      ...
      inputParam[0] = new SqlDBParameter("@DocTypePid", SqlDbType.Int, ConstantClass.Invoice_Seller);
      DataSet dsInit = SqlDataBaseAccess.SearchStoreProcedure("spACCARInvoiceOutList_Init", inputParam);
      ...
      Utility.LoadUltraCombo(ucbActionCode, dsInit.Tables[2], "ActionCode", "ActionName", false, "ActionCode");
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 5;
      string storeName = "spACCARInvoiceOut_List";

      DBParameter[] inputParam = new DBParameter[paramNumber];
      if (txtInvoiceCode.Text.ToString().Trim().Length > 0)
      {
        inputParam[0] = new DBParameter("@InvoiceCode", DbType.String, txtInvoiceCode.Text.ToString());
      }
      ...
      {
        ugdInformation.Rows[i].Appearance.BackColor = (DBConvert.ParseInt(ugdInformation.Rows[i].Cells["Status"].Value) == 1 ? Color.LightGray : Color.White);
      }
    ...
    /// <param name="e"></param>
    private void viewACC_13_007_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
    ...
    private void ugdInformation_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
    {
      ...
      e.Layout.Bands[0].Columns["InvoiceCode"].Header.Caption = "Mã chứng từ";
      e.Layout.Bands[0].Columns["InvoiceDate"].Header.Caption = "Diễn giải";
      e.Layout.Bands[0].Columns["InvoiceDesc"].Header.Caption = "Mô tả";
    ...
    {
      Utility.ExportToExcelWithDefaultPath(ugdInformation, "Danh sách phiếu thu");
    }
    ...
    private void btnNew_Click(object sender, EventArgs e)
    {
      ...
      {
        viewACC_13_006 view = new viewACC_13_006();
        view.actionCode = DBConvert.ParseInt(ucbActionCode.Value);
        Shared.Utility.WindowUtinity.ShowView(view, "Tạo mới hóa đơn bán hàng", false, ViewState.MainWindow);
      }
      else
      {
        WindowUtinity.ShowMessageErrorFromText("Vui lòng chọn loại hóa đơn bán hàng.");
      }
    }
    ...
    private void ugdInformation_MouseDoubleClick(object sender, MouseEventArgs e)
    {
      ...
      Shared.Utility.WindowUtinity.ShowView(view, "Chi tiết hóa đơn bán hàng", false, ViewState.MainWindow);
    }
    #endregion event
  }
}
