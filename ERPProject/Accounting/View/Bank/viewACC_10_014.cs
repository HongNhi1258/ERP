...
{
  public partial class viewACC_10_014 : MainUserControl
  {
    #region field
    ...
    private void InitData()
    {
      ...
      inputParam[0] = new SqlDBParameter("@DocTypePid", SqlDbType.Int, ConstantClass.Payment_BankDebit);
      DataSet dsInit = SqlDataBaseAccess.SearchStoreProcedure("spACCBankDebitList_Init", inputParam);
      ...
      Utility.LoadUltraCombo(ucbDocAction, dsInit.Tables[2], "Value", "Display", false, "Value");
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 6;
      string storeName = "spACCBankDebit_List";

      DBParameter[] inputParam = new DBParameter[paramNumber];
      if (txtBankDebitCode.Text.ToString().Trim().Length > 0)
      {
        inputParam[0] = new DBParameter("@BankDebitCode", DbType.String, txtBankDebitCode.Text.ToString());
      }
      ...
      inputParam[5] = new DBParameter("@DocTypePid", DbType.Int32, ConstantClass.Payment_BankDebit);
    ...
    /// <param name="e"></param>
    private void viewACC_10_014_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
    ...
    private void ugdInformation_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
    {
      ...
      e.Layout.Bands[0].Columns["BankDebitCode"].Header.Caption = "Mã chứng từ";
      e.Layout.Bands[0].Columns["BankDebitDesc"].Header.Caption = "Diễn giải";
    ...
    {
      if (ucbDocAction.SelectedRow != null)
      {
        int actionCode = DBConvert.ParseInt(ucbDocAction.SelectedRow.Cells["Value"].Value);
        if (actionCode == 1 || actionCode == 4)
        {
          viewACC_10_013 view = new viewACC_10_013();
          view.actionCode = actionCode;
          Shared.Utility.WindowUtinity.ShowView(view, "Tạo mới báo nợ ngân hàng", false, ViewState.MainWindow);
        }
      }
    }
    ...
    private void ugdInformation_MouseDoubleClick(object sender, MouseEventArgs e)
    {
      ...
      Shared.Utility.WindowUtinity.ShowView(view, "Chi tiết báo nợ ngân hàng", false, ViewState.MainWindow);
    }
    #endregion event
  }
}
