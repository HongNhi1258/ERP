...
{
  public partial class viewACC_10_019 : MainUserControl
  {
    #region field
    ...
    private void InitData()
    {
      ...
      DataSet dsInit = SqlDataBaseAccess.SearchStoreProcedure("spACCBankLoanReceipt_Init");
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 4;
      string storeName = "spACCBankLoanReceipt_List";
    ...
    /// <param name="e"></param>
    private void viewACC_10_019_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
    ...
    private void ugdInformation_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
    {
      ...
      e.Layout.Bands[0].Columns["ReceiptDate"].Header.Caption = "Ngày nhận nợ";
    ...
    {
      Utility.ExportToExcelWithDefaultPath(ugdInformation, "Danh sách khế ước ngân hàng");
    }
    ...
    {
      viewACC_10_017 view = new viewACC_10_017();
      Shared.Utility.WindowUtinity.ShowView(view, "Tạo mới khế ước ngân hàng", false, ViewState.MainWindow);
    }
    ...
    private void ugdInformation_MouseDoubleClick(object sender, MouseEventArgs e)
    {
      ...
      Shared.Utility.WindowUtinity.ShowView(view, "Chi tiết khế ước ngân hàng", false, ViewState.MainWindow);
    }
    #endregion event
  }
}
