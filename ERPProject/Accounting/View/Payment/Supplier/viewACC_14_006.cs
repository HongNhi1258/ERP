...
{
  public partial class viewACC_14_006 : MainUserControl
  {
    #region field
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 7;
      string storeName = "spACCSupplierPayment_SearchDoc";
    ...
    /// <param name="e"></param>
    private void viewACC_14_006_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
    ...
    private void ugdInformation_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
    {
      ...
      e.Layout.Bands[0].Columns["InvoiceDate"].Header.Caption = "Ngày\nhóa đơn";
