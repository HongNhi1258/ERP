...
{
  public partial class viewACC_14_004 : MainUserControl
  {
    #region field
    ...
    {
      DataSet dsInit = SqlDataBaseAccess.SearchStoreProcedure("spACCSupplierPaymentList_Init");
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 7;
      string storeName = "spACCSupplierPayment_Search";
    ...
    /// <param name="e"></param>
    private void viewACC_14_004_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
    ...
    private void btnNew_Click(object sender, EventArgs e)
    {
      ...
      {
        viewACC_14_005 view = new viewACC_14_005();
        view.actionCode = DBConvert.ParseInt(ucbActionDoc.Value);
        Shared.Utility.WindowUtinity.ShowView(view, "Tạo mới trả tiền NCC", false, ViewState.MainWindow);
      }
      else
      {
    ...
    private void ugdInformation_MouseDoubleClick(object sender, MouseEventArgs e)
    {
      ...
      Shared.Utility.WindowUtinity.ShowView(view, "CT Trả Tiền NCC", false, ViewState.MainWindow);
    }
    #endregion event
  }
}
