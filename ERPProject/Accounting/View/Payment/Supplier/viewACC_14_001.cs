...
{
  public partial class viewACC_14_001 : MainUserControl
  {
    #region field
    ...
    private void InitData()
    {
      ...
      DataSet dsInit = SqlDataBaseAccess.SearchStoreProcedure("spACCPaymentProposalList_Init", inputParam);
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 7;
      string storeName = "spACCPaymentProposal_Search";

      DBParameter[] inputParam = new DBParameter[paramNumber];
      if (txtProposalCode.Text.ToString().Trim().Length > 0)
      {
        inputParam[0] = new DBParameter("@ProposalCode", DbType.String, txtProposalCode.Text.ToString());
      }
    ...
    {
      txtProposalCode.Text = string.Empty;
    ...
    /// <param name="e"></param>
    private void viewACC_14_001_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
    ...
    private void ugdInformation_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
    {
      ...
      e.Layout.Bands[0].Columns["ProposalCode"].Header.Caption = "Phiếu ĐNTT";
      e.Layout.Bands[0].Columns["ProposalDate"].Header.Caption = "Ngày chứng từ";
      ...
      e.Layout.Bands[0].Columns["ProposalDesc"].Header.Caption = "Diễn giải";
    ...
    {
      Utility.ExportToExcelWithDefaultPath(ugdInformation, "Danh sách phiếu ĐNTT");
    }
    ...
    {
      viewACC_14_002 view = new viewACC_14_002();
      Shared.Utility.WindowUtinity.ShowView(view, "Tạo mới ĐNTT", false, ViewState.MainWindow);
    }
    ...
    private void ugdInformation_MouseDoubleClick(object sender, MouseEventArgs e)
    {
      ...
      Shared.Utility.WindowUtinity.ShowView(view, "Chi tiết ĐNTT", false, ViewState.MainWindow);
    }
    #endregion event
  }
}
