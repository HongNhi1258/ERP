/*
  ...
  Date        : 14/07/2021
  Description : Customer Payment list
...
{
  public partial class viewACC_14_007 : MainUserControl
  {
    #region field
    ...
    {
      DataSet dsInit = SqlDataBaseAccess.SearchStoreProcedure("spACCCustomerPaymentList_Init");
    ...
    private void SearchData()
    {
      ...
      int paramNumber = 7;
      string storeName = "spACCCustomerPaymentList_Search";
    ...
    /// <param name="e"></param>
    private void viewACC_14_007_Load(object sender, EventArgs e)
    {
      // Add KeyDown even for all controls in groupBoxSearch
    ...
    private void btnNew_Click(object sender, EventArgs e)
    {
      ...
      {
        viewACC_14_008 view = new viewACC_14_008();
        view.actionCode = DBConvert.ParseInt(ucbActionDoc.Value);
        Shared.Utility.WindowUtinity.ShowView(view, "Tạo mới thu tiền KH", false, ViewState.MainWindow);
      }
      else
      {
        WindowUtinity.ShowMessageErrorFromText("Vui lòng chọn loại thanh toán.");
      }
    }
    ...
    private void ugdInformation_MouseDoubleClick(object sender, MouseEventArgs e)
    {
      ...
      Shared.Utility.WindowUtinity.ShowView(view, "CT Thu Tiền KH", false, ViewState.MainWindow);
    }
    #endregion event
  }
}
