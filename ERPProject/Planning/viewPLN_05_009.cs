...
namespace DaiCo.ERPProject
{
  public partial class viewPLN_05_009 : MainUserControl
  {
    ...
    {
      // Customer
      Utility.LoadCustomer(cmbCustomer);
    }
    ...
    private void LoadDirectCustomer()
    {
      if (this.cmbCustomer.SelectedIndex > 0)
      {
        ...
        Utility.LoadCombobox(cmbDirectCustomer, dtSource, "Pid", "Customer");
      }
    }
    ...
    private bool CheckIsValid(out string message)
    {
      ...
      // Customer :
      this.customerPid = DBConvert.ParseLong(Utility.GetSelectedValueCombobox(cmbCustomer));
    ...
    private void btnAddItem_Click(object sender, EventArgs e)
    {
      #region Check
      // Customer :
      long customerPid = DBConvert.ParseLong(Utility.GetSelectedValueCombobox(cmbCustomer));
      ...
      {
        directCus = DBConvert.ParseLong(Utility.GetSelectedValueCombobox(cmbDirectCustomer));
