  ...
  public partial class viewPLN_10_052 : MainUserControl
  {
    ...
    private void InitData()
    {
      ...
      if (ds != null)
      {
        ...
        Utility.LoadUltraCombo(ultCBInputCUS, ds.Tables[1], "CustomerPid", "CustomerName", "CustomerPid");
        Utility.LoadUltraCombo(ultCBInputWorkArea, ds.Tables[2], "Pid", "StandByEN", "Pid");
      }
    }
