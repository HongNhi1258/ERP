  ...
  public partial class viewPLN_29_009 : MainUserControl
  {
    ...
    private void ultraGridInformation_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
    {
      ...
      if (this.flagImport == true)
      {
        ...
        e.Layout.Bands[0].Columns["IsConfirmedPAKDeadline"].Style = Infragistics.Win.UltraWinGrid.ColumnStyle.CheckBox;
        e.Layout.Bands[0].Columns["IsConfirmedSUBDeadline"].Style = Infragistics.Win.UltraWinGrid.ColumnStyle.CheckBox;
      ...
      else
      {
        ...
        e.Layout.Bands[0].Columns["DraftPAKDeadline"].Hidden = true;
        e.Layout.Bands[0].Columns["CARLock"].Hidden = true;
        e.Layout.Bands[0].Columns["CARConfirmed"].Hidden = true;
        e.Layout.Bands[0].Columns["DepartmentInput"].Hidden = true;
        e.Layout.Bands[0].Columns["CARRemark"].Hidden = true;
        e.Layout.Bands[0].Columns["MakeTransaction"].Hidden = true;
    ...
    {
      Utility.ExportToExcelWithDefaultPath(ultraGridInformation, "Deadline Information");
    }
