...
namespace DaiCo.ERPProject
{
  public partial class viewPLN_06_007 : MainUserControl
  {
    ...
    {
      e.Layout.Reset();
      Utility.SetPropertiesUltraGrid(ultContainerList);
    ...
    private void btnSearch_Click(object sender, EventArgs e)
    {
      ...
      lbCount.Text = string.Format("Count: {0}", ultContainerList.Rows.FilteredInRowCount > 0 ? ultContainerList.Rows.FilteredInRowCount : 0);
    }
