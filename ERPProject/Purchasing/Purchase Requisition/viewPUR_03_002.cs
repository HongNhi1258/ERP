  ...
  public partial class viewPUR_03_002 : DaiCo.Shared.MainUserControl
  {
    ...
    private int SavePrDetailInfo(out double amount)
    {
      ...
      if (this.prDetailPid == long.MinValue)
      {
        ...
        inputParamInsert[1] = new DBParameter("@MaterialCode", DbType.AnsiString, 16, Utility.GetSelectedValueUltraCombobox(ultMaterials));
        ...
        inputParamInsert[4] = new DBParameter("@CurrencyPid", DbType.Int64, DBConvert.ParseLong(Utility.GetSelectedValueUltraCombobox(ultCurrency)));
        inputParamInsert[5] = new DBParameter("@ExchangeRate", DbType.Double, DBConvert.ParseDouble(this.txtExchangeRate.Text));
        inputParamInsert[6] = new DBParameter("@Urgent", DbType.Int32, DBConvert.ParseLong(Utility.GetSelectedValueUltraCombobox(ultUrgentLevel)));
        ...
        inputParamInsert[10] = new DBParameter("@Imported", DbType.Int32, DBConvert.ParseInt(Utility.GetSelectedValueUltraCombobox(ultLocalImport)));

        if (DBConvert.ParseInt(Utility.GetSelectedValueUltraCombobox(ultProjectCode)) != int.MinValue)
        {
          inputParamInsert[11] = new DBParameter("@ProjectPid", DbType.Int32, DBConvert.ParseInt(Utility.GetSelectedValueUltraCombobox(ultProjectCode)));
        }

        inputParamInsert[12] = new DBParameter("@GroupPid", DbType.Int32, DBConvert.ParseInt(Utility.GetSelectedValueUltraCombobox(ultGroupInCharge)));
      ...
      else
      {
        ...
        inputParamUpdate[0] = new DBParameter("@MaterialCode", DbType.AnsiString, 16, Utility.GetSelectedValueUltraCombobox(ultMaterials));
        ...
        inputParamUpdate[3] = new DBParameter("@CurrencyPid", DbType.Int64, DBConvert.ParseLong(Utility.GetSelectedValueUltraCombobox(ultCurrency)));
        inputParamUpdate[4] = new DBParameter("@ExchangeRate", DbType.Double, DBConvert.ParseDouble(this.txtExchangeRate.Text));
        inputParamUpdate[5] = new DBParameter("@Urgent", DbType.Int32, DBConvert.ParseLong(Utility.GetSelectedValueUltraCombobox(ultUrgentLevel)));
        ...
        inputParamUpdate[9] = new DBParameter("@Imported", DbType.Int32, DBConvert.ParseInt(Utility.GetSelectedValueUltraCombobox(ultLocalImport)));

        if (DBConvert.ParseInt(Utility.GetSelectedValueUltraCombobox(ultProjectCode)) != int.MinValue)
        {
          inputParamUpdate[10] = new DBParameter("@ProjectPid", DbType.Int32, DBConvert.ParseInt(Utility.GetSelectedValueUltraCombobox(ultProjectCode)));
        }

        inputParamUpdate[11] = new DBParameter("@GroupPid", DbType.Int32, DBConvert.ParseInt(Utility.GetSelectedValueUltraCombobox(ultGroupInCharge)));
    ...
    private bool CheckValidPrDetailInfo(out string message)
    {
      ...
      // Materials
      string materials = Utility.GetSelectedValueUltraCombobox(ultMaterials);
      ...
      // Currency
      int currency = DBConvert.ParseInt(Utility.GetSelectedValueUltraCombobox(ultCurrency));
      ...
      // Local/Import
      int type = DBConvert.ParseInt(Utility.GetSelectedValueUltraCombobox(ultLocalImport));
      ...
      // Urgent Level
      int urgentLevel = DBConvert.ParseInt(Utility.GetSelectedValueUltraCombobox(ultUrgentLevel));
      ...
      // Group In Charge
      int groupInCharge = DBConvert.ParseInt(Utility.GetSelectedValueUltraCombobox(ultGroupInCharge));
      ...
      {
        int projectCode = DBConvert.ParseInt(Utility.GetSelectedValueUltraCombobox(ultProjectCode));
