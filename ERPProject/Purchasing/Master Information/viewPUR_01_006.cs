...
namespace DaiCo.ERPProject
{
  public partial class viewPUR_01_006 : MainUserControl
  {
    ...
    private void Search()
    {
      ...
      string materialGroup = Utility.GetSelectedValueUltraCombobox(ultComboMaterialGroup);
      if (materialGroup.Length == 0)
      {
        materialGroup = ultComboMaterialGroup.Text.Trim();
      }
      string materialCategory = Utility.GetSelectedValueUltraCombobox(ultComboMaterialCategory);
    ...
    private void btnExport_Click(object sender, EventArgs e)
    {
      ...
      {
        Utility.ExportToExcelWithDefaultPath(ultData, "MaterialList");
      }
    }
