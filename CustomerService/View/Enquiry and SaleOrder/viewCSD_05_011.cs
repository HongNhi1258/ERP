...
{
  public partial class viewCSD_05_011 : MainUserControl
  {
    private bool resize = false;

    public viewCSD_05_011()
    {
      InitializeComponent();
    ...
    private void viewCSD_05_011_Load(object sender, EventArgs e)
    {
      this.LoadData();
    }
    ...
    {
      viewCSD_05_009 uc = new viewCSD_05_009();
    ...
    private void dt_POCancelDateFrom_KeyDown(object sender, KeyEventArgs e)
    {
      if (e.KeyCode == Keys.Enter)
        this.btnSearch_Click(sender, e);
    }

    private void dt_POCancelDateTo_KeyDown(object sender, KeyEventArgs e)
    {
      if (e.KeyCode == Keys.Enter)
        this.btnSearch_Click(sender, e);
    }
    ...
    private void btnExportExcel_Click(object sender, EventArgs e)
    {
      if (ultData.Rows.Count > 0)
      {
        ...
        Controls.Add(UG);
        ControlUtility.ExportToExcelWithDefaultPath(UG, out xlBook, "Report Cancel List", 6);
