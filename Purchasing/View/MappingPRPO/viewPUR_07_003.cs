/*
  Author      : Dang 
  Date        : 30/06/2012
  Description : List Receiving Note Special For Woods
*/
...
{
  public partial class viewPUR_07_003 : MainUserControl
  {
    #region Field
    // Store
    string SP_ListReceivingForMaterial = "spPURListReceivingSpecialForWoods_Select";
    #endregion Field

    #region Init
    public viewPUR_07_003()
    {
      InitializeComponent();
    }

    private void viewPUR_07_003_Load(object sender, EventArgs e)
    {
      this.LoadData();
    }
    #endregion Init
    ...
    private void ultData_DoubleClick(object sender, EventArgs e)
    {
      ...
      if (type == 1)
      {
        viewPUR_07_004 uc = new viewPUR_07_004();
        uc.receivingPid = receivingPid;
        WindowUtinity.ShowView(uc, "MAPPING PRPO FOR WOODS", false, ViewState.MainWindow);
      }
    }
