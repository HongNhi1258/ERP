...
namespace DaiCo.Purchasing
{
  public partial class viewPUR_01_003 : MainUserControl
  {
    ...
    private string SaveData()
    {
      ...
      double warningPricePercent = DBConvert.ParseDouble(txtWarningPricePercent.Text);
      ...
      {
        input[16] = new DBParameter("@WarningPricePercent", DbType.Double, warningPricePercent);
      }
      if (this.materialCode.Length > 0)
      {
