...
{
  public partial class viewPUR_04_004 : MainUserControl
  {
    #region Init
    ...
    #region Field
    public viewPUR_04_004()
    {
      InitializeComponent();
    }

    private void viewPUR_04_004_Load(object sender, EventArgs e)
    {
      // Load data
      this.LoadData();
    }
    ...
    private void LoadData()
    {
      ...
      txtOrderRemark.Text = dtSource.Rows[0]["OrderRemark"].ToString();
      ...
      //    if (dtSource.Rows[0]["OrderRemark"].ToString().Length > 0)
      //    {
      //      txtOrderRemark.Text = this.StripHTML(dtSource.Rows[0]["OrderRemark"].ToString());
      //    }
      //    else
      //    {
      //      txtOrderRemark.Text = "Packing:\r\nDelivery time:\r\nDelivery term:\r\nPayment type:\r\nPayment time:\r\nWarranty:\r\nRemark:";
    ...
    private void btnSave_Click(object sender, EventArgs e)
    {
      ...
      inputParam[0] = new DBParameter("@PONo", DbType.AnsiString, this.PONo);
      if (txtOrderRemark.Text.Length > 0)
      {
        inputParam[1] = new DBParameter("@OrderRemark", DbType.String, txtOrderRemark.Text);
      }
      ...
      DataBaseAccess.ExecuteStoreProcedure("spPURPOInformationOrderRemark_Update", inputParam, outputParam);
