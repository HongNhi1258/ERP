...
{
  public partial class viewPUR_06_004 : MainUserControl
  {
    #region Init
    public viewPUR_06_004()
    {
      InitializeComponent();
    }
    ...
    private void viewPLN_06_006_Load(object sender, EventArgs e)
    {
      ...
      // Load Group Purchaser
      this.LoadComboPurchaser();

      // Load Name Purchaser
      this.LoadComboPurchaserName();
    }
    ...
    /// Load UltraCombo Purchaer
    /// </summary>
    private void LoadComboPurchaserName()
    {
      string commandText = @"SELECT ID_NhanVien, CAST(ID_NhanVien AS VARCHAR) + ' - ' + HoNV + ' ' + TenNV Name
                             FROM VHRNhanVien
                             WHERE Department = 'PUR'";
      System.Data.DataTable dtSource = DataBaseAccess.SearchCommandTextDataTable(commandText);

      ultCBPurchaser.DataSource = dtSource;
      ultCBPurchaser.DisplayMember = "Name";
      ultCBPurchaser.ValueMember = "ID_NhanVien";
      ultCBPurchaser.DisplayLayout.Bands[0].ColHeadersVisible = false;
      ultCBPurchaser.DisplayLayout.Bands[0].Columns["ID_NhanVien"].Hidden = true;
    }
    /// <summary>
    /// Load UltraCombo Lead Time
    /// </summary>
    ...
    private void Search()
    {
      ...
      if (ultCBPurchaser.Value != null && ultCBPurchaser.Value.ToString().Length > 0)
      {
        input[10] = new DBParameter("@Purchaser", DbType.Int32, DBConvert.ParseInt(ultCBPurchaser.Value.ToString()));
      }

      DataTable dtSource = DataBaseAccess.SearchStoreProcedureDataTable("spPURReOrderMaterialNewReceipt_Select", 3000, input);
    ...
    private void ExportExcel()
    {
      ...
      {
        ControlUtility.ExportToExcelWithDefaultPath(ultDetail, "ReOrder Material");
        //Excel.Workbook xlBook;
        //UltraGrid AA = this.ultDetail;

        //ControlUtility.ExportToExcelWithDefaultPath(AA, out xlBook, "ReOrder Material", 7);
        ...
        //xlSheet.Cells[3, 1] = "REORDER MATERIAL";
    ...
    {
      viewPUR_06_004 view = new viewPUR_06_004();
