/*
  Author      : 
  Date        : 01/06/2012(Quoc Te Thieu Nhi)
  Description : Min-Max (Module)
  Update      : Truong Them Show Column
*/
...
{
  public partial class viewPUR_06_003 : MainUserControl
  {
    #region Init
    public viewPUR_06_003()
    {
      InitializeComponent();
    }
    ...
    private void LoadComboMaterialCode()
    {
      ...
      commandText += "  SELECT MaterialCode ID_SanPham, MaterialCode + ' - ' + NameEN Name";
      commandText += "  FROM TblGNRMaterialInformation";
      commandText += "  WHERE [Status] <= 2 AND MaterialCode LIKE '011-%'";
    ...
    {
      string commandText = string.Empty;
      commandText += "  SELECT ID_NhanVien, ";
      commandText += "  		CAST(ID_NhanVien AS VARCHAR) + ' - ' + HoNV + ' ' + TenNV Name";
      commandText += "  FROM VHRNhanVien";
      commandText += "  WHERE Department = 'PUR'";
      commandText += "  	AND Resigned = 0";

      System.Data.DataTable dtSource = DataBaseAccess.SearchCommandTextDataTable(commandText);

      ultPurchaser.DataSource = dtSource;
      ultPurchaser.DisplayMember = "Name";
      ultPurchaser.ValueMember = "ID_NhanVien";
      ultPurchaser.DisplayLayout.Bands[0].ColHeadersVisible = false;
      ultPurchaser.DisplayLayout.Bands[0].Columns["Name"].Width = 350;
      ultPurchaser.DisplayLayout.Bands[0].Columns["ID_NhanVien"].Hidden = true;
    }
    ...
    {
      string commandText = "SELECT Pid ID_NhaCC, EnglishName Name FROM TblPURSupplierInfo";
      System.Data.DataTable dtSource = DataBaseAccess.SearchCommandTextDataTable(commandText);
    ...
    private void Search()
    {
      ...
      {
        input[5] = new DBParameter("@MaterialCode", DbType.String, ultMaterialCode.Value.ToString());
      }
      ...
      {
        input[9] = new DBParameter("@Purchaser", DbType.Int32, DBConvert.ParseInt(ultPurchaser.Value.ToString()));
      }

      DataTable dtSource = DataBaseAccess.SearchStoreProcedureDataTable("spPURReOrderVeneerNew_Select", 300, input);

      for (int i = 11; i > 0; i--)
      {
        LastMonthDate = DateTime.Now.AddMonths(-i);
        DBParameter[] inputIssue = new DBParameter[2];
        inputIssue[0] = new DBParameter("@Month", DbType.Int32, LastMonthDate.Month);
        inputIssue[1] = new DBParameter("@Year", DbType.Int32, LastMonthDate.Year);

        DataTable dt = DataBaseAccess.SearchStoreProcedureDataTable("spPURGetIssueInformationVeneer_Select", inputIssue);
        ...
        dtSource.Columns.Add(column2, typeof(System.Double));
        foreach (DataRow row in dtSource.Rows)
        {
          ...
          row[column1] = DBConvert.ParseDouble(foundRows[0]["RECQtyOut"].ToString());
          row[column2] = DBConvert.ParseDouble(foundRows[0]["ISSQtyOut"].ToString());
        }
      }
      ...
      for (int j = 0; j < dtSource.Rows.Count; j++)
      {
        ...
        if (DBConvert.ParseInt(row["TrungBinhTon"].ToString()) != int.MinValue)
        {
          ...
          {
            if (DBConvert.ParseDouble(row[k + 20].ToString()) != double.MinValue)
            {
              double value = 0;
              if (DBConvert.ParseDouble(row[k + 20].ToString()) == double.MinValue)
              {
              ...
              {
                value = DBConvert.ParseDouble(row[k + 20].ToString());
              }
    ...
    private void ultDetail_InitializeLayout(object sender, InitializeLayoutEventArgs e)
    {
      ...
      for (int i = 1; i < ultDetail.DisplayLayout.Bands[0].Columns.Count; i++)
      {
        ...
        //}
        if (i == 22 - 1 || i == 24 - 1 || i == 26 - 1 || i == 28 - 1 || i == 30 - 1 || i == 32 - 1 || i == 34 - 1
              || i == 36 - 1 || i == 38 - 1 || i == 40 - 1 || i == 42 - 1)
        {
          e.Layout.Bands[0].Columns[i].CellAppearance.BackColor = Color.LightBlue;
        }

        if (i == 23 - 1 || i == 25 - 1 || i == 27 - 1 || i == 29 - 1 || i == 31 - 1 || i == 33 - 1 || i == 35 - 1
              || i == 37 - 1 || i == 39 - 1 || i == 41 - 1 || i == 43 - 1)
        {
    ...
    private void bnExport_Click(object sender, EventArgs e)
    {
      ...
      //{
      //  oXlsReport.Cell("**Month1").Value = dtSource.Columns[21].ColumnName;
      //  oXlsReport.Cell("**Month2").Value = dtSource.Columns[22].ColumnName;
      //  oXlsReport.Cell("**Month3").Value = dtSource.Columns[23].ColumnName;
      //  oXlsReport.Cell("**Month4").Value = dtSource.Columns[24].ColumnName;
      //  oXlsReport.Cell("**Month5").Value = dtSource.Columns[25].ColumnName;
      //  oXlsReport.Cell("**Month6").Value = dtSource.Columns[26].ColumnName;
      //  oXlsReport.Cell("**Month7").Value = dtSource.Columns[27].ColumnName;
      //  oXlsReport.Cell("**Month8").Value = dtSource.Columns[28].ColumnName;
      //  oXlsReport.Cell("**Month9").Value = dtSource.Columns[29].ColumnName;
      //  oXlsReport.Cell("**Month10").Value = dtSource.Columns[30].ColumnName;
      //  oXlsReport.Cell("**Month11").Value = dtSource.Columns[31].ColumnName;
      //  oXlsReport.Cell("**Month12").Value = dtSource.Columns[32].ColumnName;
      //  oXlsReport.Cell("**Month13").Value = dtSource.Columns[33].ColumnName;
      //  oXlsReport.Cell("**Month14").Value = dtSource.Columns[34].ColumnName;
      //  oXlsReport.Cell("**Month15").Value = dtSource.Columns[35].ColumnName;
      //  oXlsReport.Cell("**Month16").Value = dtSource.Columns[36].ColumnName;
      //  oXlsReport.Cell("**Month17").Value = dtSource.Columns[37].ColumnName;
      //  oXlsReport.Cell("**Month18").Value = dtSource.Columns[38].ColumnName;
      //  oXlsReport.Cell("**Month19").Value = dtSource.Columns[39].ColumnName;
      //  oXlsReport.Cell("**Month20").Value = dtSource.Columns[40].ColumnName;
      //  oXlsReport.Cell("**Month21").Value = dtSource.Columns[41].ColumnName;
      //  oXlsReport.Cell("**Month22").Value = dtSource.Columns[42].ColumnName;
      ...
      //      oXlsReport.Cell("**1", 0, i).Value = DBConvert.ParseDouble(row.Cells[21].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**2", 0, i).Value = DBConvert.ParseDouble(row.Cells[22].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**3", 0, i).Value = DBConvert.ParseDouble(row.Cells[23].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**4", 0, i).Value = DBConvert.ParseDouble(row.Cells[24].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**5", 0, i).Value = DBConvert.ParseDouble(row.Cells[25].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**6", 0, i).Value = DBConvert.ParseDouble(row.Cells[26].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**7", 0, i).Value = DBConvert.ParseDouble(row.Cells[27].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**8", 0, i).Value = DBConvert.ParseDouble(row.Cells[28].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**9", 0, i).Value = DBConvert.ParseDouble(row.Cells[29].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**10", 0, i).Value = DBConvert.ParseDouble(row.Cells[30].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**11", 0, i).Value = DBConvert.ParseDouble(row.Cells[31].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**12", 0, i).Value = DBConvert.ParseDouble(row.Cells[32].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**13", 0, i).Value = DBConvert.ParseDouble(row.Cells[33].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**14", 0, i).Value = DBConvert.ParseDouble(row.Cells[34].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**15", 0, i).Value = DBConvert.ParseDouble(row.Cells[35].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**16", 0, i).Value = DBConvert.ParseDouble(row.Cells[36].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**17", 0, i).Value = DBConvert.ParseDouble(row.Cells[37].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**18", 0, i).Value = DBConvert.ParseDouble(row.Cells[38].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**19", 0, i).Value = DBConvert.ParseDouble(row.Cells[39].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**20", 0, i).Value = DBConvert.ParseDouble(row.Cells[40].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**21", 0, i).Value = DBConvert.ParseDouble(row.Cells[41].Value.ToString());
      //    }
      //    else
      //    {
      ...
      //    {
      //      oXlsReport.Cell("**22", 0, i).Value = DBConvert.ParseDouble(row.Cells[42].Value.ToString());
      //    }
      //    else
      //    {
      ...
      {
        ControlUtility.ExportToExcelWithDefaultPath(ultDetail, "ReOrder Veneer");
        //Excel.Workbook xlBook;
        //UltraGrid AA = this.ultDetail;

        //ControlUtility.ExportToExcelWithDefaultPath(AA, out xlBook, "ReOrder Veneer", 7);
        ...
        //xlSheet.Cells[3, 1] = "REORDER VENEER";
    ...
    private void btnMakePR_Click(object sender, EventArgs e)
    {
      ...
      view.dtData = dt;
      Shared.Utility.WindowUtinity.ShowView(view, "MAKE PR", false, DaiCo.Shared.Utility.ViewState.ModalWindow, FormWindowState.Maximized);
    ...
    private void ultShowColumns_InitializeLayout(object sender, InitializeLayoutEventArgs e)
    {
      ...
      if (DBConvert.ParseInt(this.txtMonth.Text) != int.MinValue)
      {
        int j = 12 - DBConvert.ParseInt(this.txtMonth.Text);
        for (int i = 22; i < 22 + j; i++)
        {
          e.Layout.Bands[0].Columns[i].Hidden = true;
        }
      }
