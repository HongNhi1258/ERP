...
namespace DaiCo.TransactionImplement
{
  ...
  /// </summary>
  public class UpdateObjectTransaction : ITransaction
  {
    ...
    #region Constructor
    // init 
    public UpdateObjectTransaction(IObject obj, params string[] primaryKeyNames)
    {
      this.obj = obj;
      ...
      {
        throw new TransactionException("UpdateObjectTransaction", "PrimaryKeyNames in this method is invalid");
      }
    }
    ...
    public void Execute()
    {
      ...
      try
      {
        ...
        // make sql query
        IQuery query = new UpdateObjectSqlFactory(this.obj, arrColumns, this.GetIdentityFieldName(strTableName), primaryKeyNames);
      ...
      catch (Exception e)
      {
        result = false;
        //throw to trace log
        throw new TransactionException("UpdateObjectTransaction", e);
      }
    }
